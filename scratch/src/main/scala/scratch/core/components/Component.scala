package scratch.core.components

trait Component {

}

import scratch.vector.vec
import scratch.vector.vec2
import scratch.common
import scratch.core.Update
import scratch.gfx
...
trait Verlet2D extends Acceleration2D with Update {
  ...
  private[scratch] override def __update(dt:common.Real) {
    super.__update(dt)
